package com.library.slider.IndicatorView.animation.data;

import androidx.annotation.NonNull;

import com.library.slider.IndicatorView.animation.data.type.ColorAnimationValue;
import com.library.slider.IndicatorView.animation.data.type.DropAnimationValue;
import com.library.slider.IndicatorView.animation.data.type.FillAnimationValue;
import com.library.slider.IndicatorView.animation.data.type.ScaleAnimationValue;
import com.library.slider.IndicatorView.animation.data.type.SwapAnimationValue;
import com.library.slider.IndicatorView.animation.data.type.ThinWormAnimationValue;
import com.library.slider.IndicatorView.animation.data.type.WormAnimationValue;
